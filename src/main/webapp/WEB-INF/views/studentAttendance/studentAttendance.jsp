			...
			<div class="row ">
				<div class="span12">
					<div class="centered">
						...
						<form:form action="${action}" method="${method}" cssClass="form-inline" id="studentListForm"
							...
							<c:if test="${showTab eq 'edit'}">
								<table class="table " id="studentList" >
									...
									<tbody>
										<tr>
											<td>
												<form:hidden path="studentAttendanceId" name="studentAttendanceId" />
											...
											<td style="text-align: center">
												<form:input path="noOfDays" name="noOfDays"
															id="noOfDays" cssStyle="text-align: right"
															maxlength="3" cssClass="span1" onkeyup="intOnly(this)"/>
											</td>
											<td style="text-align: center">
												<form:input path="daysPresent" name="daysPresent"
							...
							<c:if test="${not empty studentAttendanceDto.attendanceDtos}">
								<table class="table " id="studentList" >
									<thead>
									<th>S. No.</th>
									<th scope="row">Batch</th>
									...
									<tbody>
									<c:forEach items="${studentAttendanceDto.attendanceDtos}" var="attendanceDto" varStatus="row">
										<tr>
											<td>${row.index+1}
												<form:hidden
											...
											<td style="text-align: center">
												<c:choose>
													<c:when test="${attendanceDto.noOfDays != 0}">
											...
											<td style="text-align: center">
												<c:choose>
													<c:when test="${attendanceDto.daysPresent != 0}">
											...
											<td>
												<c:if test="${attendanceDto.studentAttendanceId gt 0}">

													<a href="JavaScript:void(0);" style="color: mediumblue"
													   onclick="edit('${Role}/student/studentAttendance/edit/${attendanceDto.studentAttendanceId}/update','Post')">
														Edit</a>
													</a>
													<span style="padding: 10px"></span>

													<a href="JavaScript:void(0);" style="color: red"
													   onclick="edit('${Role}/student/studentAttendance/edit/${attendanceDto.studentAttendanceId}/delete','Post')">Delete</a>
								...
								<button type="button" class="btn btn-primary"
										onclick="submitData('${Role}/student/studentAttendance/add','studentListForm')">
									Post Attendance
								</button>
							</c:if>
						</form:form>
